...
include '../config.php';
      ...
      {      /* $query1="";    $query2="";    $query3="";    $query4=""; */
          ...
          if ($_POST['from']!="") {
              ...
              $conexion->query($query1)or die('<script type="text/javascript">location.reload();</script>');
          ...
          if ($_POST['from2']!="") {
              ...
              $conexion->query($query3)or die('<script type="text/javascript">window.location.reload()</script>');
...
<head>
    ...
    <link rel="stylesheet" href="<?=$base_url2?>css/calendar.css">
    <link href="<?=$base_url2?>css/font-awesome.min.css" rel="stylesheet">
    <script type="text/javascript" src="<?=$base_url2?>js/es-ES.js"></script>
    <script src="<?=$base_url2?>js/jquery.min.js"></script>
    <script src="<?=$base_url2?>js/moment.js"></script>
    <script src="<?=$base_url2?>js/bootstrap.min.js"></script>
    <script src="<?=$base_url2?>js/bootstrap-datetimepicker.js"></script>
    <link rel="stylesheet" href="<?=$base_url2?>css/bootstrap-datetimepicker.min.css" />
...
<body style="background: white;" onload="muestrames()">
    <div class="container">
        <div class="row"> 
                <br><br><br>
            <h1 class="section-heading">Equipment Cleaning</h1>
    ...
    <script src="<?=$base_url2?>js/underscore-min.js"></script>
    <script src="<?=$base_url2?>js/calendar.js"></script>
        ...
        (function($){
                ...
                var options = {
                    ...
                    modal: '#events-modal', 
                        ...
                        events_source: '<?=$base_url2?>obtener_eventos.php', 
                ...
                <div class="modal-body">
                    ...
                    <table style='width:80%;margin-left:5rem;'>
                        <tr><td style='width:48%;'>
                            ...
                            <table style='border:thin solid black;width:85%;'>
