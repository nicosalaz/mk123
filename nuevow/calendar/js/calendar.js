...
(function($) {
	...
	Calendar.prototype.navigate = function(where, next) {
		...
		if(where == 'next') { 
			...
			switch(this.options.view) {
				case 'year':
					var valorx = parseInt($("#yearx").val())+1;
						$("#yearx").val(valorx);
					to.start.setFullYear(this.options.position.start.getFullYear() + 1);					
					break;
				case 'month':
					var valory = parseInt($("#monthx").val())+1;
						$("#monthx").val(valory);
						if (valory=='1') { $("#monthw").html("January");}
						if (valory=='2') { $("#monthw").html("February");}
						if (valory=='3') { $("#monthw").html("March");}
						if (valory=='4') { $("#monthw").html("April");}
						if (valory=='5') { $("#monthw").html("May");}
						if (valory=='6') { $("#monthw").html("June");}
						if (valory=='7') { $("#monthw").html("July");}
						if (valory=='8') { $("#monthw").html("August");}
						if (valory=='9') { $("#monthw").html("September");}
	...
	Calendar.prototype._update = function() {
		...
		$('.cal-cell').dblclick(function() {
			var fechax=$('[data-cal-date]', this).data('cal-date');
			var mes= fechax.substring(5,7); 
			$("#monthx").val(mes);	
			if (mes=='01') { $("#monthw").html("January");}
			if (mes=='02') { $("#monthw").html("February");}
			if (mes=='03') { $("#monthw").html("March");}
			if (mes=='04') { $("#monthw").html("April");}
			if (mes=='05') { $("#monthw").html("May");}
			if (mes=='06') { $("#monthw").html("June");}
			if (mes=='07') { $("#monthw").html("July");}
			if (mes=='08') { $("#monthw").html("August");}
			if (mes=='09') { $("#monthw").html("September");}
			if (mes=='10') { $("#monthw").html("October");}
			if (mes=='11') { $("#monthw").html("November");}
			if (mes=='12') { $("#monthw").html("December");}
