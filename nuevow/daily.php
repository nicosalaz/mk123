...
<html lang="en" xmlns:mso="urn:schemas-microsoft-com:office:office" xmlns:msdt="uuid:C2F41010-65B3-11d1-A29F-00AA00C14882">
  ...
  <div class="container">
      ...
      <div class="container">
        ...
        <table class="responsive">
              <thead>
                <tr>
                  <th class="titulox2">Shift</th>
                  <th class="titulox2">Lot<br> Number</th>
                  <th class="titulox2">Container</th>
                  <th class="titulox2">Supervisor</th>
                  <th class="titulox2">Blisters <br> Shippers <br>Shift End</th>
                  <th class="titulox2">Filler <br>Counter <br> Shift End</th>
                  <th class="titulox2">Filler<br> Counter <br> Rejects</th>
                  <th class="titulox2">Unprinted<br> Blisters <br>in PCF</th>
                  <th class="titulox2">Printed <br> Blisters<br> in PCF</th>
                  <th class="titulox2">Shift <br> Lenght</th>
                  <th class="titulox2">Gravimetrics <br> /1000U</th>
                  <th class="titulox2">Frit <br> Change</th>
                  <th class="titulox2">Cell<br>1</th>
                  <th class="titulox2">Cell<br>2</th>
                  <th class="titulox2">Cell<br>3</th>
                  <th class="titulox2">Cell<br>4</th>
                  <th class="titulox2">Cell<br>5</th>
                  <th class="titulox2">Cell<br>6</th>
                  <th class="titulox2">Cell<br>7</th>
                  <th class="titulox2">Klockner</th>
                  <th class="titulox2">Printer</th>
                  <th class="titulox2">Leak <br> test</th>
                  <th class="titulox2">Unplanned <br> Other</th>
                  <th class="titulox2">Total <br> Time</th>
                </tr>
              </thead>
          <tbody>
           ...
           <?php 
            ...
            if ($totalfilas>0) {
                ...
                while($fila = mysqli_fetch_array($result2) ){ 
                    ...
                    $shiftx2[$j]= $fila[1];
                    $lotnumber2[$j]= $fila[2]; ?>
                    <tr onmouseover="loteelegido2('<?php echo $shiftx2[$j] ?>','<?php echo $lotnumber2[$j] ?>')">
                      <?php 
                            $comentario= vercomment($conn,$shiftx2[$j],$lotnumber2[$j]); 
                          
                     if ($shiftx2[$j]=="Total" AND $lotn <> ""){ ?>
                          <td> <?php echo $shiftx2[$j] ?> </td>
                          <td style='background:silver'></td>
                        <?php } else {  ?>
                          <td>
                            <?php  
                            if ($shiftx2[$j]>0) {      ?>
                              <button class="botonx" onclick="vercomentario(`<?php echo $comentario ?>`)"><?php echo $shiftx2[$j] ?></button>
                            <?php } else { 
                              echo $shiftx2[$j];
                            } ?>

                          </td>
                      <td> <button onclick="observationsw()" class="botonx2"><?php echo $lotnumber2[$j]?></button> </td>
                        <?php } ?>
                      ...
                      for ($i=3; $i < 24; $i++) { 
                        ...
                        if ($fila[$i]<>"") {  
                            $celda=$fila[$i]; 
                              ...
                              if ($color1=="red") { ?>                                                             
                                  <td class="uno" onmouseover="showdatayb(`<?php echo $mensaje1 ?>`)" onclick="celdaelegida2(event)">
                                     <?php echo $celda ?> 
                                  </td>
                                <?php } else { 
                                    if ($fila['shift']=='Total') { ?>

                                        <td class="dos"><?php echo $celda ?></td>

                                      <?php } else { ?>
                                        <td class="tres" onmouseover="showdatayb(`<?php echo $mensaje1 ?>`)"  onclick="celdaelegida2(event)">
                                            <?php if ($celda<>"") { ?>
                                                <?php echo $celda ?> 
                                            <?php  } ?>
                                      </td>
  ...
  <div class="hide" id="rmenub">
    ...
    <section class="section-3c" id="section-3c" style="display:none">
      <button class="botonx" style="margin-left:80%" onclick="cerrarsection()">X</button>
    ...
    <button class="botonx" style="margin-left:50%" onclick="cerrarsection()">X</button>
      ...
      <div class="container">
        ...
        <!-- <form id="historizar" method="post" 
            action="consultas.php" enctype="multipart/form-data" target="consultasx">       
      ...
      <iframe name="consultasx" src="consultas.php" frameborder="0" style="height:1rem"></iframe>
        ...
        <form id="consultaobservations" action="observations.php" 
                method="post" target="observationsx" style='display:none'>       
